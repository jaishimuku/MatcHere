    ...
    public class PhotosController : ControllerBase
    {
            ...
            [FromForm] PhotoForCreationDto photoForCreationDto) 
        {
            ...
            return Unauthorized();
             ...
             photoForCreationDto.Url = uploadResult.Url.ToString(); // Uri id deprecated, so Url
             ...
             return BadRequest("Coulnot add the photo");
        }
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id) 
        {
            ...
            return BadRequest("Couldnot make this photo as Profile Photo");
        }
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.IsMain)
            return BadRequest("Cannot delete Profile Picture");
